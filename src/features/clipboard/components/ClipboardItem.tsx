...
const RICH_IMAGE_FALLBACK_PREFIX = "<!--CPASTE_RICH_IMAGE:";
    ...
    return (
        <motion.div
            ...
            onMouseDown={(e) => {
                ...
                // e.preventDefault() stops macOS from transferring key-window focus to Cpaste
                // when the user clicks on a clipboard item, including pinned mode.
                // Without this, the first click activates Cpaste and the original input
