...
/// Prefix used to mark encrypted values in the database.
/// Encryption has been removed, but this constant remains for backward
/// compatibility checks that detect previously encrypted data.
pub const ENCRYPT_PREFIX: &str = "___ENC___";
...
pub const SENSITIVE_TAGS: &[&str] = &["加密"];
