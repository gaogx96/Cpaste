...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::match_entries_for_group,
            ...
            app::commands::list_smart_group_rules,
            app::commands::create_smart_group_example,
            app::commands::delete_smart_group_example,
            app::commands::list_smart_group_examples,
            app::commands::add_clipboard_entry_as_group_example,
            app::commands::assign_clipboard_entry_to_group,
            app::commands::remove_clipboard_entry_from_group,
            app::commands::update_clipboard_entry_note,
            app::commands::get_clipboard_history_by_group,
